    ...
    fixtureClusters: [
      {
        ...
        fixtures: [
          ...
          { kind: "chair", left: 18, top: 34 },
          { kind: "bench", left: 42, top: 56 },
          { kind: "chair", left: 46, top: 72 },
        ],
      },
      {
        id: "support-wall",
        fixtures: [
          { kind: "shelf", left: 72, top: 18 },
          { kind: "cart", left: 76, top: 64 },
        ],
      },
    ],
    stationAnchors: [
      { id: "impl-a", left: 20, top: 59 },
      { id: "impl-b", left: 46, top: 68 },
      { id: "impl-c", left: 72, top: 52 },
    ],
    taskAnchors: [
      { left: 18, top: 22 },
      { left: 48, top: 59 },
    ...
    fixtureClusters: [
      {
        ...
        fixtures: [
          ...
          { kind: "reception-return", left: 24, top: 28 },
          { kind: "board", left: 56, top: 18 },
        ],
      },
      {
        id: "commons-furniture",
        fixtures: [
          { kind: "plant", left: 74, top: 18 },
          { kind: "plant", left: 82, top: 68 },
          { kind: "chair", left: 24, top: 64 },
          { kind: "chair", left: 38, top: 64 },
          { kind: "couch", left: 58, top: 62 },
        ],
      },
      {
        id: "commons-table",
        fixtures: [
          { kind: "desk", left: 38, top: 46 },
          { kind: "chair", left: 32, top: 58 },
          { kind: "chair", left: 52, top: 58 },
          { kind: "monitor", left: 45, top: 42 },
          { kind: "note", left: 57, top: 44 },
          { kind: "coffee", left: 35, top: 43 },
        ],
      },
    ],
    stationAnchors: [
      { id: "commons-a", left: 22, top: 42 },
      { id: "commons-b", left: 45, top: 61 },
      { id: "commons-c", left: 72, top: 74 },
    ],
    taskAnchors: [
      { left: 26, top: 28 },
      { left: 60, top: 52 },
