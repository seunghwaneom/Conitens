...
export const SPATIAL_LENS_BUILDING_LAYOUT = {
  ...
  floorplateZones: [
    { id: "floorplate.left-wing", rect: { x: 1, y: 1, w: 35, h: 55 }, tone: "left-wing" },
    { id: "floorplate.center-spine", rect: { x: 33, y: 0, w: 27, h: 100 }, tone: "shell" },
    { id: "floorplate.right-wing", rect: { x: 58, y: 1, w: 35, h: 43 }, tone: "right-wing" },
    { id: "floorplate.commons-wing", rect: { x: 8, y: 57, w: 47, h: 40 }, tone: "commons-wing" },
    { id: "floorplate.review-wing", rect: { x: 58, y: 53, w: 35, h: 31 }, tone: "right-wing" },
    { id: "floorplate.bottom-service", rect: { x: 0, y: 81, w: 63, h: 17 }, tone: "service" },
  ],
  wallSegments: [
    ...
    { id: "wall.outer.west-upper", rect: { x: 1, y: 1, w: 2.4, h: 55 }, role: "outer", orientation: "vertical" },
    { id: "wall.outer.west-lower", rect: { x: 8, y: 57, w: 2.4, h: 40 }, role: "outer", orientation: "vertical" },
    { id: "wall.outer.east-upper", rect: { x: 90.6, y: 1, w: 2.4, h: 43 }, role: "outer", orientation: "vertical" },
    { id: "wall.outer.east-lower", rect: { x: 90.6, y: 53, w: 2.4, h: 31 }, role: "outer", orientation: "vertical" },
    { id: "wall.outer.south-left", rect: { x: 8, y: 94.6, w: 47, h: 2.4 }, role: "outer", orientation: "horizontal" },
    ...
    { id: "wall.trim.top-operations", rect: { x: 3, y: 20.8, w: 30, h: 0.8 }, role: "trim", orientation: "horizontal" },
    { id: "wall.trim.impl-commons", rect: { x: 3, y: 55.4, w: 50, h: 0.8 }, role: "trim", orientation: "horizontal" },
    { id: "wall.trim.right-wing-seam", rect: { x: 58, y: 44.6, w: 35, h: 0.8 }, role: "trim", orientation: "horizontal" },
    { id: "wall.trim.review-seam", rect: { x: 58, y: 53, w: 35, h: 0.8 }, role: "trim", orientation: "horizontal" },
  ],
  columns: [
    ...
    { id: "column.mid-junction-left", point: { left: 35.7, top: 55.5 }, size: "small" },
    { id: "column.mid-junction-right", point: { left: 57.7, top: 44.2 }, size: "small" },
